...
using System.Linq;
using MSHB.Reservation.Shared.Common.Captcha.Contracts;

namespace MSHB.Reservation.Shared.Common.Captcha.Providers
{
	/// <summary>
	...
	public class HumanReadableIntegerProvider : IHumanReadableIntegerProvider
	{
		...
		private readonly IList<NumberWord> _numberWords = new List<NumberWord>
		{
			...
			new NumberWord { Group= DigitGroup.Teens, Language= Language.Persian, Names=
				new List<string> { "ده", "یازده", "دوازده", "سیزده", "چهاشهر", "پانزده", "شانزده", "هفده", "هجده", "نوزده" }},
